<?php 
    ...
    if(isset($_POST['kullanici_adi']) and isset($_POST['sifre'])) {
        ...
        $sql=$sql."kullanici_adi='$kullanici_adi' and sifre='$sifre'";
      ...
      <div class="col-md-5">
        <div class="card shadow-lg p-3 mb-5 bg-body rounded">
          <div class="card-header bg-transparent border-dark ">
            <h3 style="color: #3d3d5c ; margin-left: 30%">Doktor Girişi</h3>
          </div>
          <div class="card-body">
            <form class="" action="<?php $_PHP_SELF ?>" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="kullanici_adi" required placeholder="Kullanıcı Adı">
              </div>
              <div class="mb-3">
                <label for="" class="form-label" style="color: black;">
                  <h6>ŞİFRE</h6>
